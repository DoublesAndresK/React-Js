...
const Navbar = ({quantity}) => {
  ...
  return (
    <>
      <div className="navbar bg-base-300 rounded-md my-3">
        <div className="flex-1">
        <label htmlFor="my-drawer" className="btn btn-primary drawer-button bg-red-400"><AiOutlineMenuUnfold/></label>
          ...
          <div className="dropdown dropdown-end">
            <label tabIndex={0} className="btn btn-ghost btn-circle avatar">
              <div className="w-10 rounded-full">
                <img src={userData?.image} className=" w-20 bg-red-400" />
              </div>
            </label>
            <ul
              tabIndex={0}
